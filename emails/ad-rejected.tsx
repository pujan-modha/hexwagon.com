...
const EmailAdRejected = ({ ad, ...props }: EmailProps) => {
  return (
    <EmailWrapper signature {...props}>
      ...
      <Text>
        Thanks for booking an ad on {config.site.name}. Unfortunately, it was not approved.
      </Text>
      ...
      {ad.refundedAt ? (
        ...
        <Text>
          Because this campaign was paid, a full refund will be issued back to your original payment
          method.
        </Text>
      ) : null}
