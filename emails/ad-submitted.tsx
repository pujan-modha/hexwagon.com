...
const EmailAdSubmitted = ({ ad, ...props }: EmailProps) => {
  return (
    <EmailWrapper signature {...props}>
      ...
      <Text>
        We received your ad booking for <strong>{ad.websiteUrl}</strong> on{" "}
        {config.site.name}.
      </Text>

      <Text>
        Our team will review it shortly. We&apos;ll email you once it&apos;s
        approved.
      </Text>

      <Text>
        Campaign dates: {ad.startsAt.toLocaleDateString()} -{" "}
