...
export const portHrefFromTheme = (themeSlug: string, platformSlug: string, portId: string) =>
...
export const portHrefFromPlatform = (platformSlug: string, themeSlug: string, portId: string) =>
