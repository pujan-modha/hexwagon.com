          ...
          {maintainers.map(maintainer => (
            <Stack key={maintainer.userId} className="justify-between rounded border px-3 py-2">
              <div className="truncate">
                <div className="text-sm font-medium truncate">{maintainer.user.name || "Unknown"}</div>
                <div className="text-xs text-muted-foreground truncate">{maintainer.user.email}</div>
              </div>
