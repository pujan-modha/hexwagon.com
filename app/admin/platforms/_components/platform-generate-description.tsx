...
import type { PlatformSchema } from "~/server/admin/platforms/schema"

export const PlatformGenerateDescription = () => {
  const errorMessage = "Something went wrong. Please check the console for more details."
  const successMessage = "Description generated successfully. Please save the platform to update."

  const { watch, setValue } = useFormContext<PlatformSchema>()
