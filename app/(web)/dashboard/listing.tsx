...
import { DashboardMaintainedThemesSection } from "~/app/(web)/dashboard/maintained-themes-section";
...
import { findMaintainedThemes } from "~/server/web/theme-maintainers/queries";
...
export const DashboardToolListing = async ({
  ...
  const maintainedThemes = await findMaintainedThemes(session.user.id);
  ...
  return (
    <>
      ...
      <DashboardMaintainedThemesSection themes={maintainedThemes} />
