...
import { createStripeAdPackageCheckout, updateAdPackageDraft } from "~/actions/stripe"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="email" size="lg" placeholder="you@company.com" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem className="sm:col-span-2">
                  <div className="mb-3">
                    ...
                    <p className="text-[13px] text-muted-foreground leading-tight mt-1">
                      Auto-fetched from website URL. You can override via direct URL or file upload.
                    </p>
                  </div>
              ...
              <div className="p-5 sm:p-6 pb-5">
                ...
                <div className="flex items-baseline gap-2 mb-4">
                  <Price
                    ...
                    interval={pricingSummary.billingCycle === "Monthly" ? "month" : "week"}
                ...
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex justify-between items-center">
                    <span>Base package ({pricingSummary.billingCycle.toLowerCase()})</span>
