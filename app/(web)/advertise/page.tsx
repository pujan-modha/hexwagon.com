    ...
    <div className="flex flex-col gap-12 md:gap-14 lg:gap-16">
      <Intro alignment="center">
        ...
        <IntroDescription className="max-w-3xl">
          Promote your business or software and reach a wide audience of tech
          enthusiasts. Check our{" "}
          <ExternalLink href={config.links.analytics}>
            real-time analytics
          </ExternalLink>{" "}
      ...
      <Intro alignment="center">
        ...
        <Button className="mt-4 min-w-40" asChild>
          <ExternalLink href={`mailto:${config.site.email}`}>
            Contact us
          </ExternalLink>
        </Button>
      </Intro>
